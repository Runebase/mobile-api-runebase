# Public Key
Represents a RUNEBASE public key and is needed to be able to receive RUNEBASE, as is usually represented as a RUNEBASE [Address](address.md). 

A PublicKey in runebasecore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new runebasecore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = runebasecore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
