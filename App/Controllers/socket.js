...
const RunebaseRoomEvents = require('../Components/SocketEvents/RunebaseRoomEvents');
...
class SocketController {
    ...
    initSocketEvents() {
        ...
        this.events.runebaseRoomEvents = new RunebaseRoomEvents(this.socket, this.socketClient);
    ...
    socketHandler(socket) {
        ...
        socket.on('disconnect', () => {
            ...
            this.events.runebaseRoomEvents.unsubscribeAddress(socket, null);
    ...
    subscribe_balance_change(socket, addresses, options) {
        ...
        this.events.runebaseRoomEvents.subscribeAddress(socket, addresses);
    ...
    unsubscribe_balance(socket, addresses, options) {
        ...
        this.events.runebaseRoomEvents.unsubscribeAddress(socket, addresses);
