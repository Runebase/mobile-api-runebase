...
const logger = require('log4js').getLogger('RunebaseRoomEvents Socket Events');
...
class RunebaseRoomEvents {
    ...
    initRemoteSocket() {
        ...
        this.socketClient.on('connect', () => {
            ...
            this.subscribeRemoteRunebaseRoom();
        });
        ...
        this.subscribeToRunebaseBlock();
        this.subscribeToRunebaseTrx();

    }

    subscribeToRunebaseBlock() {

        this.socketClient.on('runebase/block', (data) => {
    ...
    subscribeToRunebaseTrx() {

        this.socketClient.on('runebase/tx', (data) => {
    ...
    subscribeRemoteRunebaseRoom() {
        this.socketClient.emit('subscribe', 'runebase');
    }
...
module.exports = RunebaseRoomEvents;